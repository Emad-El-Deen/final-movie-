      ...
      <div className="row mt-5">
        ...
        <div className="col-md-7 offset-1 d-flex align-items-center">
          <div className=""> 
            ...
            <p className='text-white mt-3 fs-5 fw-lighter bio'>{peopleDetails.biography}</p>
            <div className='mt-4'>
              <h2 className='h6 '><span>Birthday:</span> {peopleDetails.birthday ? peopleDetails.birthday : 'No data available'}</h2>
